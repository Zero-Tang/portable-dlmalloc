...
cl malloc.c /I"%incpath%\ucrt" /I"%ddkpath%\include" /D"PORTABLE" /D"USE_DL_PREFIX" /D"NO_MALLOC_STATS=1" /D"USE_LOCKS=2" /D"MSPACES" /D"DEFAULT_GRANULARITY=0x200000" /Zi /nologo /W3 /WX /Oi /Od /Zc:wchar_t /FAcs /Fa"%objpath%\malloc.cod" /Fo"%objpath%\malloc.obj" /Fd"%objpath%\vc140.pdb" /GS- /std:c17 /Qspectre /TC /c /errorReport:queue

lib "%objpath%\malloc.obj" /NOLOGO /OUT:"%binpath%\dlmalloc.lib" /Machine:X64 /ERRORREPORT:QUEUE

echo Compiling Sample...
cl .\port_uefi.c /I"%mdepath%\Include" /I"%mdepath%\Include\X64" /Zi /nologo /W3 /WX /Od /Zc:wchar_t /FAcs /Fa"%objpath%\sample.cod" /Fo"%objpath%\sample.obj" /Fd"%objpath%\vc140.pdb" /GS- /TC /c /errorReport:queue

link "%objpath%\sample.obj" "%binpath%\dlmalloc.lib" /NODEFAULTLIB /LIBPATH:"%libpath%\compchk_uefix64" "MdePkgGuids.lib" "BaseLib.lib" "BaseDebugPrintErrorLevelLib.lib" "BaseMemoryLib.lib" "BasePrintLib.lib" "UefiLib.lib" "UefiDebugLibConOut.lib" "UefiMemoryAllocationLib.lib" "UefiDevicePathLibDevicePathProtocol.Lib" "UefiBootServicesTableLib.Lib" "UefiRuntimeServicesTableLib.Lib" /NOLOGO /INCREMENTAL:NO /DEBUG /PDB:"%binpath%\bootx64.pdb" /OUT:"%binpath%\bootx64.efi" /ENTRY:"EfiEntry" /SUBSYSTEM:EFI_APPLICATION /Machine:X64 /ERRORREPORT:QUEUE
