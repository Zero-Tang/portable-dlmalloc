...
fn main()
{
	...
	{
		Command::new(format!("{}\\bin\\Hostx64\\x64\\cl.exe",DDK_PATH!())).args(&["../malloc.c",
		...
		Command::new(format!("{}\\bin\\Hostx64\\x64\\lib.exe",DDK_PATH!())).args(&[format!("{}\\malloc.obj",out_dir).as_str(),"/NOLOGO",
